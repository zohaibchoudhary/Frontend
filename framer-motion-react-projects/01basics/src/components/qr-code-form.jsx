...
export default function QRCodeForm() {
	return (
      ...
      <Label htmlFor="email" className="w-max text-lg sm:text-xl tracking-tighter font-semibold">Enter your QR Code destination</Label>
      <Input 
      type="text" 
      ...
      />
			...
			<CardFooter>
				...
				className="flex items-center w-full justify-center gap-2 sm:text-lg bg-orange-500 hover:bg-orange-600 text-center sm:w-max px-6 py-3 font-medium text-dark rounded-full tracking-tight">
					Get your QR Code for free <ArrowRight className="h-5 w-5" />
				</Link>
			</CardFooter>
		</Card>
	);
